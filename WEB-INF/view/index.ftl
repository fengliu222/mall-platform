	...
	<section class="g-doc">
		<div class="g-body">
			...
			<div class="g-center m-top">
				...
				<span class="m-top-buttons">
					<span class="m-top-userbar">
						<a href="###">我的买卖</a>
						<i class="f-iconfont">&#xe661</i>
					</span>
					<span class="m-top-cyt">
						<a href="###">畅易通</a>
					</span>
					<span class="m-top-advice">
						<a href="###">意见反馈</a>
					</span>
					<span class="m-top-help">
						<a href="###">帮助中心</a>
					</span>
					<span class="m-top-stolenback">
						<a href="###">被盗找回</a>
					</span>
			...
			<header class="g-body m-header">
				<div class="g-center m-header-inner">
					...
					<div class="m-header-search">
						...
						<button class="m-header-searchBtn">搜索</button>
					</div>
			...
			<section class="g-body">
				<section class="g-center">
					...
					<article class="m-banner">
						...
						<div class="m-banner-notice">
							<i class="f-iconfont">&#xe61f</i>
							最新成交
							<span>
